...
## 3.6 Turning Turtles (Positional Nim)
...
## 3.7 Silver Dollar Game (Coin Gap Nim)
...
## 3.8 White Knight / Black Knight Game
...
## 3.9 Nim with Limited Takes (Arbitrary Subtraction Game)
...
## 3.11 Nim-Multiplication (2D Coin Turning Games)
