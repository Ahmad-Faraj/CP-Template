...
/*
 * Topic: Data Structures - Cartesian Tree
 * Description: A Cartesian tree is a tree data structure created from a set of data that obeys
 *              the following structural invariants:
 *              1. The tree obeys the min (or max) heap property.
 *              2. An inorder traversal yields the values in their original sequence.
 *              LCA(i, j) corresponds to the RMQ(i, j) in the original array.
 */
